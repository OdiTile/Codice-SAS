/* file tabel8n1.sas     20 luglio 2004                      */
...
/ selection = stepwise slentry = 0.25 slstay = 0.25 include = 12;
run; */
/*
...
/* escludo f12 scienze politiche */
proc logistic ; /* descending ; */     
model fgh6 =  f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11  f13 
sesso ld lav lavorava etalaurea votolaurea 
/ link = logit selection = stepwise slentry=0.25 slstay=0.25  include=12  details ;
run;
proc freq;
tables fac * fgh6;
tables lavorava ;
