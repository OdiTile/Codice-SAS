/* file tabel9.sas     24 luglio 2004                      */
/* sequenza import021.sas  -  merge021.sas  -  tabella19.sas */
/* tabella19.sas    tabella 19                              */
...
tables fac * fgh6;
run; */
/* Canali di ricerca attiva del lavoro per tid */
...
by tid;
run;
/* Canali di ricerca attiva del lavoro per lavora - non lavora */
proc sort data=dforces18 ;
by lav;
run;
proc reg ;      
