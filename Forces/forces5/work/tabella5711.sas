/* file tabella5711.sas     2-2-06                      */
/* sequenza import522.sas  -  merge522.sas  -  tabella5711.sas */
/*                                                                      */
...
if tid= "T4" then varb84=b8;
if tid= "T5" then varb85=b8;
...
proc sort data=lib.dforces01 out=lib.dforces01tid;
/*ordinamento per tid per la proc mean  sul totale*/
by tid; run;
proc means data=lib.dforces01tid n sum mean;
var pric;
by tid;
...
set lib.dforces01;
lavora=2; lavora6=2;
if b8=1 then lavora=1;
if varb86=1 then lavora6=1;
run;
proc freq data=lib.dforces01;
tables fgh6 *lavora6 * tid;
* tables fgh6 * tid;
